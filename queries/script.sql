...
CREATE TABLE Condicoes_Paciente (
    ID_Condicoes INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Alergias_Paciente (
    ID_Alergias INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Sala_de_Raio_X(
    ID_Sala_Raio_X INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY
);


CREATE TABLE Sala(
    ID_Sala INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Leito(
    ID_Leito INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Atendimento(
    ID_Atendimento INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Hospital(
    ID_Hospital INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Transferência(
    ID_Transferência INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Equipamento_Raio_X(
    ID_Equipamento INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
    Nome VARCHAR(30) NOT NULL,
...
CREATE TABLE Amostra_Coletada(
    ID_Amostra INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Consultório(
    ID_Consultório INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE Turno(
    ID_Turno INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
